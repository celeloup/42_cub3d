...
/*   Updated: 2020/05/03 15:57:19 by celeloup         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	window_set(t_window *win, char *filename)
{
	...
	win->ui.dialog_box.img_ptr = mlx_xpm_file_to_image(win->mlx_ptr, \
		"bonus_images/dialogue_box.xpm", &win->ui.dialog_box.width, &win->ui.dialog_box.height);
	win->ui.dialog_box.data = (int*)mlx_get_data_addr(win->ui.dialog_box.img_ptr, \
		&win->ui.dialog_box.bpp, &win->ui.dialog_box.s_l, &win->ui.dialog_box.endian);
	win->ui.dialog_box.name = "dialogue";
